...
A un certain moment, j'ai réussi à les créer seulement en faisant apparaitre "Syllabe 1"
```{r}
...
sample_1_c <- rnorm(5, mean = 1, sd = 6)
...
data_set_1 <- data.frame("value" = sample_1, "group" = "1")
data_set_2 <- data.frame("value" = sample_2, "group" = "2")
data_set_3 <- data.frame("value" = sample_3, "group" = "3")
data_set_4 <- data.frame("value" = sample_4, "group" = "4")
data_set_5 <- data.frame("value" = sample_5, "group" = "5")
data_set_6 <- data.frame("value" = sample_6, "group" = "6")
data_set_7 <- data.frame("value" = sample_7, "group" = "7")
data_set_8 <- data.frame("value" = sample_8, "group" = "8")
stat_power <- rbind(data_set_1, data_set_2, data_set_3, data_set_4, data_set_5, 
                    data_set_6, data_set_7, data_set_8)
